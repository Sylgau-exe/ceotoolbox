...
-- Pricing
('Ho Chi Minh City','show_price_floor','Permanent-show price floor (VN market)','pricing','2026-07','2026-07-21',25,NULL,'USD','OTA scan (Klook/Traveloka) first pass','https://www.klook.com/en-US/city/32-ho-chi-minh-city/','M','Bottom of observed VN permanent-show band','2026-07-21'),
('Ho Chi Minh City','show_price_ceiling','Permanent-show price ceiling (A O Show)','pricing','2026-07','2026-07-21',69,NULL,'USD','OTA scan (Klook/Traveloka) first pass','https://www.klook.com/en-US/city/32-ho-chi-minh-city/','H','A O Show top tier = market ceiling','2026-07-21'),
('Ho Chi Minh City','ticket_aoshow','A O Show — reference gross ticket','pricing','2026-07','2026-07-21',1808000,NULL,'VND','OTA scan first pass','https://www.klook.com/en-US/search/?query=vietnam%20show','H','~US$69 at 26,200 VND/USD; weight 40% in price analysis','2026-07-21'),
